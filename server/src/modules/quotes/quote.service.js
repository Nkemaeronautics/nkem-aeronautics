...
// Mirrors the client's catalogue tabs (client/src/lib/catalog.js CATALOG_SECTORS).
const QUOTE_SECTORS = ["agricultural", "wildlife", "realestate", "evtol"];
...
export async function create(body) {
  ...
  if (!body.targetCountry) throw new HttpError(400, "targetCountry is required.");
